...
(function () {
    ...
    Runner.prototype = {
         ...
         */
        scheduleNextUpdate: function () {
            if (!this.up                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
         ...
         */
        scheduleNextUpdate: function () {
            if (!this.updat                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
         ...
         */
        scheduleNextUpdate: function () {
            if (!this.updatePe                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
        ...
        scheduleNextUpdate: function () {
            if (!this.updatePending) {
                this.updatePendi                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
        ...
        scheduleNextUpdate: function () {
            if (!this.updatePending) {
                this.upda                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
         ...
         * RequestAnimationFrame wrapper.
         */
        scheduleNextUpdate:                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
         ...
         */
        scheduleNextUpdate: function () {
            if (!this.upda                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
         ...
         * RequestAnimationFrame wrapper.
         */
        scheduleNextUpdate: functio                this.tRex.setDuck(false);
            } else if (this.crashed) {
                // Check that enough time has elapsed before allowing jump key to restart.
                var deltaTime = getTimeStamp() - this.time;
...
n () {
            if (!this.updatePending) {
                this.updatePenupdatePendingding = true;
                this.raqId = requestAnimationFrame(this.update.bind(this));
            }
        },
 function () {
