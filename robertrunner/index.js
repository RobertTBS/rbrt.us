    ...
    Runner.prototype = {
        ...
        gameOver: function () {
            ...
            if (this.distanceRan > this.highestScore) {
              ...
              //ROBERT
              setHigh(this.distanceRan/40); //ROBERT
              onload()
            }
...
function endit(){
  let highscore = getCookie("highscore");
var pr = prompt("High score is "+highscore)
if (pr == 'color'){document.body.style.background = prompt("Choose a JS compatable color")}
}
//load()